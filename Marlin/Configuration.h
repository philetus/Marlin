...
#define MANUAL_Z_HOME_POS 232  // For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 28, -13, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
